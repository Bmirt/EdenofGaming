 ...
 extends React.Component {
    constructor() {
      ...
      onSubmit(e) {
        ...
        axios
          .post(`http://localhost:5000/api/profile/privatemessage/${this.state.value}`, newMessage, config )
          .then(res => {
            console.log(res.data);
            alert("succesfully replyed");
            window.location = "/";
          })
                            ...
                            <div className="form-group">
                              <div className="col-xs-12">
                                ...
                                <button
                                  ...
                                  type="submit"
                                >
                                  <i className="glyphicon glyphicon-ok-sign" />reply
                                </button>
