...
class UpdateUserName extends React.Component {
  ...
  onSubmit(e) {
    ...
    axios
      .post(`/api/profile/changename/${this.state.value}`, newName, config)
      .then(res => {
                ...
                >
                  <div className="form-group">
                    <div className="col-xs-6">
                      <label htmlFor="value">
                        <h4 className="user-profile__input-title">user id</h4>
                      </label>
                      <input
                        type="text"
                  ...
                  <div className="form-group">
                    <div className="col-xs-6">
                      <label htmlFor="game_name">
                        <h4 className="user-profile__input-title">new name</h4>
                      </label>
                      <input
                        type="text"
                        name="name"
