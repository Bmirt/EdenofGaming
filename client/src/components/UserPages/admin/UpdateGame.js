...
class UpdateGame extends React.Component {
  ...
  onSubmit(e) {
    ...
    console.log(newInfo);
    axios
      .patch(`/api/products/${this.state.name}`, newInfo)
      .then(res => {
              ...
              <div className="row">
                ...
                >
                  <div className="form-group">
                    <div className="col-xs-6">
                      <label htmlFor="game_name">
                        <h4 className="user-profile__input-title">game id</h4>
                      </label>
                      <input
                        type="text"
                        name="name"
                  ...
                  <div className="form-group">
                    <div className="col-xs-6">
                      <label htmlFor="propName">
                        <h4 className="user-profile__input-title">propName</h4>
                      </label>
                      <input
                        type="text"
                        className="form-control user-profile__input"
                  ...
                  <div className="form-group">
                    <div className="col-xs-6">
                      <label htmlFor="value">
                        <h4 className="user-profile__input-title">value</h4>
                      </label>
                      <input
                        type="text"
                        className="form-control user-profile__input"
