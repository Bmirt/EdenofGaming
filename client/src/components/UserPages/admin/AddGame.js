              ...
              <div className="row">
                ...
                >
                  ...
                  <div className="form-group">
                    <div className="col-xs-6">
                      <label htmlFor="genre">
                        <h4 className="user-profile__input-title">genre</h4>
                      </label>
                      <input
                        type="text"
                        className="form-control user-profile__input"
                  ...
                  <div className="form-group">
                    <div className="col-xs-6">
                      <label htmlFor="trailer">
                        <h4 className="user-profile__input-title">trailer</h4>
                      </label>
                      <input
                        type="text"
                        className="form-control user-profile__input"
                  ...
                  <div className="form-group">
                    <div className="col-xs-6">
                      <label htmlFor="reliase">
                        <h4 className="user-profile__input-title">release</h4>
                      </label>
                      <input
                        type="text"
                        className="form-control user-profile__input"
                  ...
                  <div className="form-group">
                    <div className="col-xs-6">
                      <label htmlFor="platforms">
                        <h4 className="user-profile__input-title">platforms</h4>
                      </label>
                      <input
                        type="text"
                        className="form-control user-profile__input"
                  ...
                  <div className="form-group">
                    <div className="col-xs-6">
                      <label htmlFor="price">
                        <h4 className="user-profile__input-title">price</h4>
                      </label>
                      <input
                        type="text"
                        className="form-control user-profile__input"
                  ...
                  <div className="form-group">
                    <div className="col-xs-6">
                      <label htmlFor="cdkey">
                        <h4 className="user-profile__input-title">cdkey</h4>
                      </label>
                      <input
                        type="text"
                        className="form-control user-profile__input"
                  ...
                  <div className="form-group">
                    <div className="col-xs-6">
                      <label htmlFor="developer">
                        <h4 className="user-profile__input-title">developer</h4>
                      </label>
                      <input
                        type="text"
                        className="form-control user-profile__input"
